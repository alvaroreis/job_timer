...
const ProjectSchema = CollectionSchema(
  name: 'Project',
  schema:
      '{"name":"Project","idName":"id","properties":[{"name":"estimate","type":"Long"},{"name":"name","type":"String"},{"name":"status","type":"Long"}],"indexes":[],"links":[{"name":"taks","target":"ProjectTask"}]}',
  idName: 'id',
...
void _projectAttachLinks(IsarCollection col, int id, Project object) {
  object.taks.attach(col, col.isar.projectTasks, 'taks', id);
}
...
extension ProjectQueryLinks
    on QueryBuilder<Project, Project, QFilterCondition> {
  QueryBuilder<Project, Project, QAfterFilterCondition> taks(
