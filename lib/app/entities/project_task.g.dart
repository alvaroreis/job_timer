...
const ProjectTaskSchema = CollectionSchema(
  name: 'ProjectTask',
  schema:
      '{"name":"ProjectTask","idName":"id","properties":[{"name":"creatAt","type":"Long"},{"name":"duration","type":"Long"},{"name":"name","type":"String"}],"indexes":[],"links":[]}',
  idName: 'id',
  propertyIds: {'creatAt': 0, 'duration': 1, 'name': 2},
  listProperties: {},
  indexIds: {},
  indexValueTypes: {},
  linkIds: {},
...
void _projectTaskSerializeNative(
    ...
    AdapterAlloc alloc) {
  var dynamicSize = 0;
  final value0 = object.creatAt;
  final _creatAt = value0;
  ...
  writer.writeDateTime(offsets[0], _creatAt);
...
ProjectTask _projectTaskDeserializeNative(
  ...
  object.creatAt = reader.readDateTime(offsets[0]);
...
dynamic _projectTaskSerializeWeb(
  ...
  IsarNative.jsObjectSet(
      jsObj, 'creatAt', object.creatAt.toUtc().millisecondsSinceEpoch);
...
ProjectTask _projectTaskDeserializeWeb(
  ...
  final object = ProjectTask();
  object.creatAt = IsarNative.jsObjectGet(jsObj, 'creatAt') != null
      ? DateTime.fromMillisecondsSinceEpoch(
              IsarNative.jsObjectGet(jsObj, 'creatAt'),
              isUtc: true)
          .toLocal()
...
P _projectTaskDeserializePropWeb<P>(Object jsObj, String propertyName) {
  switch (propertyName) {
    case 'creatAt':
      return (IsarNative.jsObjectGet(jsObj, 'creatAt') != null
          ? DateTime.fromMillisecondsSinceEpoch(
                  IsarNative.jsObjectGet(jsObj, 'creatAt'),
                  isUtc: true)
              .toLocal()
...
extension ProjectTaskQueryFilter
  ...
  QueryBuilder<ProjectTask, ProjectTask, QAfterFilterCondition> creatAtEqualTo(
      DateTime value) {
  ...
  QueryBuilder<ProjectTask, ProjectTask, QAfterFilterCondition> creatAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return addFilterConditionInternal(FilterCondition(
  ...
  QueryBuilder<ProjectTask, ProjectTask, QAfterFilterCondition> creatAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProjectTaskQueryWhereSortBy
  ...
  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> sortByCreatAt() {
    return addSortByInternal('creatAt', Sort.asc);
  }

  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> sortByCreatAtDesc() {
    return addSortByInternal('creatAt', Sort.desc);
  }
...
extension ProjectTaskQueryWhereSortThenBy
  ...
  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> thenByCreatAt() {
    return addSortByInternal('creatAt', Sort.asc);
  }

  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> thenByCreatAtDesc() {
    return addSortByInternal('creatAt', Sort.desc);
  }
...
extension ProjectTaskQueryWhereDistinct
  ...
  QueryBuilder<ProjectTask, ProjectTask, QDistinct> distinctByCreatAt() {
    return addDistinctByInternal('creatAt');
  }
...
extension ProjectTaskQueryProperty
  ...
  QueryBuilder<ProjectTask, DateTime, QQueryOperations> creatAtProperty() {
    return addPropertyNameInternal('creatAt');
  }
